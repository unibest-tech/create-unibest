...
import type { PromptResult, Platform, UILibrary, RequestLibrary, TokenStrategy } from '../types';
...
export async function promptUser(
  ...
  try {
    ...
    return {
      ...
      tokenStrategy: answers.tokenStrategy as TokenStrategy
    };
  } catch (error) {
